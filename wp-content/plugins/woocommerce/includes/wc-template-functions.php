...
if ( ! function_exists( 'woocommerce_single_variation_add_to_cart_button' ) ) {
	...
	function woocommerce_single_variation_add_to_cart_button() {
		...
		<div class="variations_button">
			...
			?>
			<br />
			<button type="submit" id="add-to-cart-button" class="single_add_to_cart_button cart-button button alt">ADD TO CART</button>
			<button type="button" id="buy-now-button" class="single_add_to_cart_button button alt" >BUY NOW</button>
			
			<input type="hidden" name="add-to-cart" value="<?php echo absint( $product->id ); ?>" />
			<input type="hidden" name="product_id" value="<?php echo absint( $product->id ); ?>" />
			<input type="hidden" name="variation_id" class="variation_id" value="" />
			<input type="hidden" id="redirect-checkout" name="redirect-checkout" class="redirect-checkout" value="" />
			<script>

			 jQuery(function(){
					jQuery('#buy-now-button').click(function(){
						jQuery("#redirect-checkout").val("yes");
